...
nav: |
  ...
  * [.getBoundParentComponent()](#UIRenderable:getBoundParentComponent)
  ...
  * [.emitChange()](#UIRenderable:emitChange)
...
## ![](/assets/icons/spec-method.svg).getBoundParentComponent() {#UIRenderable:getBoundParentComponent}
{:.spec}
...
## ![](/assets/icons/spec-method.svg).getManagedParent() <span class="spec_tag">protected</span> {#UIRenderable:getManagedParent}
{:.spec}
...
## ![](/assets/icons/spec-method.svg).emitChange() {#UIRenderable:emitChange}
{:.spec}
